...
在家庭环境下，我们可能会多个操作系统需求，如办公时想用 Windows 操作系统，写代码时想用 Linux 操作系统，家庭存储时又想用群晖 NAS，或你女朋友又想用其他操作系统，这样我们需要购买 **多台设备**，**每台设备需占一定空间且每台设备不是实时要用到**。

这就衍生出来：**能不能用一台台式机同时装多个系统并同时运行？** 答案是肯定，是家庭 AIO（All-in-One）也就此顺应而生。

...
- [家庭设备支持公网 IPv6 访问](../route/ipv6.md)，并通过 [IPv6 转 IPv4 技术](../remote/ipv6-ipv4.md)，实现任意服务的远程访问；
- 搭建家庭影音中心，集中管理影片资源，支持多终端播放；
- [构建全家共享的公共存储网盘，实现文件统一存储与便捷访问](../synology/design.md)；
- 支持全家远程办公，随时随地远程 [家庭电脑](../home/pc.md)；
- [实现“全家出国旅游”场景下的网络代理访问，模拟海外 IP 环境](../route/open-clash.md)；
- [搭建公网可访问的开发/生产服务器，满足个人项目部署需求](../home/develop.md)；
